...
silent only
cd ~/work/HPlayer/audiodecode
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +31 audioplayer.cpp
badd +1 audioplayer.h
badd +1 audioworks.cpp
badd +1 audioworks.h
badd +140 ~/QTProjects/decode_test/mainwindow.cpp
badd +8 main.cpp
badd +1 test.cpp
badd +15 safequeuetest.cpp
args audioplayer.cpp
edit audioplayer.h
...
exe 'vert 1resize ' . ((&columns * 57 + 73) / 146)
exe 'vert 2resize ' . ((&columns * 88 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 51 + 73) / 146)
exe '2resize ' . ((&lines * 3 + 20) / 41)
exe 'vert 2resize ' . ((&columns * 94 + 73) / 146)
exe '3resize ' . ((&lines * 34 + 20) / 41)
exe 'vert 3resize ' . ((&columns * 94 + 73) / 146)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 137 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
