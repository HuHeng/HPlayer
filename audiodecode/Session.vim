...
badd +5 audioplayer.h
badd +99 audioworks.cpp
badd +0 audioworks.h
badd +0 ~/QTProjects/decode_test/mainwindow.cpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 95 - ((13 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
exe 'vert 1resize ' . ((&columns * 57 + 73) / 146)
exe 'vert 2resize ' . ((&columns * 88 + 73) / 146)
tabedit ~/QTProjects/decode_test/mainwindow.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 154 - ((18 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
